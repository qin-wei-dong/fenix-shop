  ...
  const features: Feature[] = [
    {
      id: 1,
      title: '极速配送',
      description: '24小时内快速配送，让您尽快收到心仪商品',
    ...
    },
    {
      id: 2,
      title: '品质保证',
      description: '严格质检，确保每一件商品都符合高品质标准',
    ...
    },
    {
      id: 3,
      title: '贴心服务',
      description: '7x24小时客服支持，随时为您解答疑问',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            我们致力于为每一位客户提供最优质的购物体验，从商品质量到售后服务，每一个细节都精益求精
          </p>
        </motion.div>
